...
angular.module('app').constant('I18N.MESSAGES', {
  ...
  'crud.temperature.save.success':"A temperature with id '{{id}}' was saved successfully.",
  'crud.temperature.remove.success':"A temperature with id '{{id}}' was removed successfully.",
  'crud.temperature.save.error':"Something went wrong when saving a temperature...",
